...
public class ClienteRepository {
	...
	public void create (Cliente cliente) throws Exception {
		...
		//Executando um comando sql(query) para inserir
		//um cliente na tabela do banco
	...
	public void update(Cliente cliente) throws Exception {
		...
		//Executando um comando sql(query) para atualizar
		//um cliente na tabela do banco
		PreparedStatement statement = connection.prepareStatement
	...
	public void delete(UUID id) throws Exception {
		...
		//executando o comando sql(query) para excluir
		//um cliente na tabela do banco
		PreparedStatement statement = connection.prepareStatement
	...
	public List<Cliente> findAll() throws Exception {
		...
		//executando o comando sql(query) para consultar
		//todos os clientes na tabela banco
		...
		//declarando uma lista de clientes, inicialmdnte vazia
	 ...
	 */
		public Cliente findById(UUID id) throws Exception {
			...
			//executando o comando sql(query) para consultar 1 cliente
			//na tabela do banco
			PreparedStatement statement = connection.prepareStatement

...
import br.com.cotiinformatica.dtos.ConsultarClientesDto;
...
/*
 * Método API para consultar todos os clientes
 */
@GetMapping("consultar")
public List<ConsultarClientesDto> getAll (){
	try {
		
		//consultar todos os clientes obtidos
		//do banco de dados
		ClienteRepository clienteRepository
			= new ClienteRepository();
		List<Cliente> lista = clienteRepository.findAll();
		
		//criando uma lista de objetos de classe DTO
		List<ConsultarClientesDto> clientes
			= new ArrayList<ConsultarClientesDto> ();
		
		//percorrendo a lista de clientes obtida
		//do banco de dados
		for(Cliente cliente : lista) {
			
			ConsultarClientesDto dto
				= new ConsultarClientesDto();
